...
func TestImageFormat(t *testing.T) {
	Convey("Test valid image", t, func() {
		...
		defaultStore := storage.NewImageStore(dbDir, false, storage.DefaultGCDelay, false, false, true, log, metrics)
...
func TestUtilsMethod(t *testing.T) {
	Convey("Test utils", t, func() {
		...
		metrics := monitoring.NewMetricsServer(false, log)
		defaultStore := storage.NewImageStore(rootDir, false, storage.DefaultGCDelay, false, false, true, log, metrics)

		subStore := storage.NewImageStore(subRootDir, false, storage.DefaultGCDelay, false, false, true, log, metrics)
