...
func testSetup() error {
	...
	storeController := storage.StoreController{DefaultStore: storage.NewImageStore(dir, false, storage.DefaultGCDelay, false, false, true, log, metrics)}
...
func TestMultipleStoragePath(t *testing.T) {
	Convey("Test multiple storage path", t, func() {
		...
		// Create ImageStore
		firstStore := storage.NewImageStore(firstRootDir, false, storage.DefaultGCDelay, false, false, true, log, metrics)

		secondStore := storage.NewImageStore(secondRootDir, false, storage.DefaultGCDelay, false, false, true, log, metrics)

		thirdStore := storage.NewImageStore(thirdRootDir, false, storage.DefaultGCDelay, false, false, true, log, metrics)
