...
type RepoDBMock struct {
	...
	AddManifestDependantFn       func(manifestDigest string, dependantDigest string) error
...
func (sdm RepoDBMock) AddManifestDependant(manifestDigest string, dependantDigest string) error {
	if sdm.AddManifestDependantFn != nil {
		return sdm.AddManifestDependantFn(manifestDigest, dependantDigest)
	}
